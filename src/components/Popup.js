		...
		<div className="popup" id="popup">
			<div className="popup__content">				
				<div className="popup__left">
					<img src="/static/images/nat-8.jpg" className="popup__image" alt="Tour" />
					<img src="/static/images/nat-9.jpg" className="popup__image" alt="Tour" />
				</div>
			...
			<a href="/#section-tours" className="popup__backdrop">&nbsp;</a>
		</div>
	);
}
